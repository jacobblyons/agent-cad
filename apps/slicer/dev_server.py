...
NOTE: this file is currently a verbatim duplicate of apps/cad/dev_server.py.
Phase 2 of the v0.2.0 split (see docs/agent-slicer.md) will extract it
into shared/python/ and both apps will import from there.
...
Use:
    proc, job = dev_server.start(FRONTEND, port=5274)
    try:
        ...
    finally:
